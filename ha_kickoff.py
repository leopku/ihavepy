...
##############################################
# HAProxy kickoff is a kit for enable/disable
# servers from haproxy.cfg
#
...
if __name__ == "__main__":
    ...
    parser.add_option('--port', metavar='321', help='Port number of one ip which to be enabled/disabled. NOTE: this parameter on work with single ip.')
    ...
    parser.add_option('--test', action='store_true', help='Make a copy of haproxy config file to the same folder of this script for testing. Any changes will save to the copy.')
